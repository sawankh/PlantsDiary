  ...
  <div role="main">
    ...
    <div id="projectDetailPage" data-role="page" class="page innerPage ">
      ...
      <div class="padpage padtop">
        <h1><a class="back" href="portfolio.php"><img src="img/icon-back.png" alt="Back" /> Project Detail</a></h1>
      </div>
      ...
      <div class="padpage">
        ...
        <h4>
          <a class="next" href="project-gallery.php"> View Project Gallery <img src="img/icon-next.png" alt="Next" /> </a>
        </h4>  
