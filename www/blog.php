  ...
  <div role="main">
    ...
    <div id="blogPage" data-role="page" class="page innerPage padpage padtop padbottom">
      ...
      <div class="blog">
        ...
        <div class="blogPost">
          <div class="head">
            <a class="left image icon" href="blog-detail.php">
              <img src="img/sample-images/blog-1.png" alt="Blog image" />
            </a>
            <div class="left title">
              <h3> <a href="blog-detail.php"> Blog Post title goes here </a> </h3>
        ...
        <div class="blogPost">
          <div class="head">
            <a class="left image" href="blog-detail.php">
              <img src="img/sample-images/blog-4.jpg" alt="Blog image" />
            </a>
            <div class="left title">
              <h3> <a href="blog-detail.php"> Most awesome clean retina design!</a> </h3>
